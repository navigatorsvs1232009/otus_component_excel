...
abstract class AbstractIblockPropertyValuesTable extends DataManager
{
     ...
     *
     * @return int Contains ID of inserted row
     *
     * @throws \Exception
     */
    /*public static function add(array $data): UpdateResult
    {
        $name = $data["NAME"]?? "NEW NAME";
        $elem_id = (new CIBlockElement)->add(["IBLOCK_ID" => static::IBLOCK_ID,"NAME"=>$name]);
        return static::update($elem_id,$data);
    }*/

    public static function add(array $data): int
    {
        if (!static::$iblockElement) {
    ...
    public static function delete($element_id): bool {
